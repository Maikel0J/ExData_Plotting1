...
### Goal
# Create a (red) histogram/barplot with the frequency of the global active power
...
### Make graphics
# Make plot
hist(df_plot$Global_active_power, col="red", xlab="Global active power (kilowatts)", ylab="Frequency", main="Global Active Power")
