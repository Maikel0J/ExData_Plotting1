...
### Goal
# A line graph of the Global active power with the weekday in the x axis.
...
# Make plot
plot(df_plot$Global_active_power,type = "S", xlab="", ylab = "Global active power (kilowatts)", xaxt='n') 
